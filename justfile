name := 'cosmic-reader'
export APPID := 'com.system76.CosmicReader'
...
dev *args:
    ...
    RUST_BACKTRACE=1 RUST_LOG=cosmic_reader=debug target/release-with-debug/cosmic-reader {{args}}
...
# Run with debug logs
run *args:
    env RUST_LOG=cosmic_reader=info RUST_BACKTRACE=full cargo run --release {{args}}
